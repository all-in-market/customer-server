...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    """)
    List<CartItem> findAllByIdInAndBuyerIdWithCartAndProduct(@Param("cartItemIds") List<Long> cartItemIds, @Param("buyerId")  Long buyerId);
    ...
    @Query("""
        ...
        WHERE ci.id IN :cartItemIds
    """)
    List<CartItem> findAllByIdsWithProduct(List<Long> cartItemIds);
}
