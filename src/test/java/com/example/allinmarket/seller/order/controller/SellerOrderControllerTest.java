...
public class SellerOrderControllerTest {
    ...
    void 판매자_주문목록_조회_성공_테스트() {
        ...
        SellerOrderGetResponse orderResponse = new SellerOrderGetResponse(
        ...
        PageResponse<SellerOrderGetResponse> pageResponse = new PageResponse<>(
                List.of(orderResponse), 1, 1, 1L, 10, true
        );
    ...
    void 판매자_주문목록_조회_빈목록_성공_테스트() {
        ...
        PageResponse<SellerOrderGetResponse> emptyPage = new PageResponse<>(
